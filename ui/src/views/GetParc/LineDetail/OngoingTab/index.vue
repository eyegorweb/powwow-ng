<template>
  <div v-if="isLigneActive" class="mb-4">
      ...
      <table v-if="consumptionData && !partnerTypeMVNO" class="table table-blue mt-1 mb-3 partnerTypeM2M">
        <thead>
          <tr>
      ...
      <table v-else-if="consumptionData && partnerTypeMVNO" class="table table-blue mt-1 mb-3 partnerTypeMVNO">
        <tbody>
          <tr>
            <td>
              <ul class="content-cell list-unstyled">
                <li class="total-line">{{ $t('getparc.lineDetail.consummated.totalVoice') }}</li>
                <li class="value-line">{{ $t('getparc.lineDetail.consummated.voiceIncomingNationalConsumption') }}</li>
                <li class="value-line">{{ $t('getparc.lineDetail.consummated.voiceOutgoingNationalConsumption') }}</li>
          ...
          <tr>
            <td>
              <ul class="content-cell list-unstyled">
                ...
                <li class="value-line">{{ $t('getparc.lineDetail.consummated.smsIncomingNationalConsumption') }}</li>
                <li class="value-line">{{ $t('getparc.lineDetail.consummated.smsOutgoingNationalConsumption') }}</li>
                <li class="value-line">{{ $t('getparc.lineDetail.consummated.smsIncomingInternationalConsumption') }}</li>
                <li class="value-line">{{ $t('getparc.lineDetail.consummated.smsOutgoingInternationalConsumption') }}</li>
              </ul>
            </td>
            <td>
              <ul class="content-cell list-unstyled">
                <li class="total-value">
                  {{ consumptionData.smsTotal }} SMS
                </li>
                <li class="value-line">
                  {{ consumptionData.smsIncomingNationalConsumption }} SMS
                </li>
                <li class="value-line">
                  {{ consumptionData.smsOutgoingNationalConsumption }} SMS
                </li>
                <li class="value-line">
