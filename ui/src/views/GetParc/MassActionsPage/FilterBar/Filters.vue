<template>
  <div>
    ...
    <FoldableBlock
      :title="$t('filters.actDateCreation')"
      :key="'el4'"
      draggable
      v-if="keyName === 'el4'"
    >
