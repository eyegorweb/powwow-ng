<template>
  <div class="creation-panel">
    ...
    <CreateAccountPanelSynthesis :synthesis="synthesis" :can-save="false" @save="saveAccount" />
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    console.log('mounted index account creation', this.$route);
  ...
  watch: {
    $route() {
      ...
      console.log('route synthesis', this.synthesis);
      if (stepData) {
        this.synthesis = {
          ...this.synthesis,
          ...stepData,
