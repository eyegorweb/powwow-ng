...
export function applySearch() {
  ...
  const searchBtnWhenOnOrderPage = '#app > div.container > div.mt-4 > div:nth-child(2) > div.col-md-3 > div.card.filter-bar > div.card-body.hide-all-filters > div:nth-child(2) > div.actions.d-flex.flex-column.flex-md-row > button';
  ...
  cy.get('body').then(($body) => {
    ...
    if(!!$body.find(searchBtnWhenCannotSaveFiltersPath).length) {
      ...
      buttonToClick = cy.get(searchBtnWhenOnOrderPage);
    }
